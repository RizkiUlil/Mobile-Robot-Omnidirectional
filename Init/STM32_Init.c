 ...
 *----------------------------------------------------------------------------*/
#ifndef __STM32_INIT_C
#define __STM32_INIT_C

//#include <stm32f10x.h>
#include <stm32f10x_lib.h>                        // STM32F10x Library Definitions
#include "../Include/STM32_Reg.h"                            // missing bit definitions
...
#define __RCC_CR_VAL               0x010D0002
...
//--------------------------------------------------------------------------- Timer 5 enabled
//   <e1.4> TIM5 : Timer 5 enabled
//     <o62> TIM5 period [us] <1-72000000:10>
//       <i> Set the timer period for Timer 5.
//       <i> Default: 1000  (1ms)
//       <i> Ignored if detailed settings is selected
//--------------------------------------------------------------------------- Timer 5 detailed settings
//     <e2.4> TIM5 detailed settings
//       <o63> TIM5.PSC: Timer 5 Prescaler <0-65535>
//         <i> Set the prescaler for Timer 5.
//       <o64> TIM5.ARR: Timer 5 Auto-reload <0-65535>
//         <i> Set the Auto-reload for Timer 5.
//       <h> Timer 5 Control Register 1 Configuration (TIM5_CR1)
//         <o65.8..9> TIM5_CR1.CKD: Clock division   
//           <i> Default: tDTS = tCK_INT
//           <i> devision ratio between timer clock and dead time
//                     <0=> tDTS = tCK_INT
//                     <1=> tDTS = 2*tCK_INT
//                     <2=> tDTS = 4*tCK_INT
//         <o65.7> TIM5_CR1.ARPE: Auto-reload preload enable
//           <i> Default: Auto-reload preload disenabled
//         <o65.5..6> TIM5_CR1.CMS: Center aligned mode selection   
//           <i> Default: Edge-aligned
//                     <0=> Edge-aligned
//                     <1=> Center-aligned mode1
//                     <2=> Center-aligned mode2
//                     <3=> Center-aligned mode3
//         <o65.4> TIM5_CR1.DIR: Direction
//           <i> Default: DIR = Counter used as up-counter
//           <i> read only if timer is configured as Center-aligned or Encoder mode   
//                     <0=> Counter used as up-counter
//                     <1=> Counter used as down-counter
//         <o65.3> TIM5_CR1.OPM: One pulse mode enable
//           <i> Default: One pulse mode disabled
//         <o65.2> TIM5_CR1.URS: Update request source   
//           <i> Default: URS = Counter over-/underflow, UG bit, Slave mode controller
//                     <0=> Counter over-/underflow, UG bit, Slave mode controller
//                     <1=> Counter over-/underflow
//         <o65.1> TIM5_CR1.UDIS: Update disable
//           <i> Default: Update enabled
//       </h>
//
//       <h> Timer 5 Control Register 2 Configuration (TIM5_CR2)
//         <o66.7> TIM5_CR2.TI1S: TI1 Selection  
//           <i> Default: TIM5CH1 connected to TI1 input
//                     <0=> TIM5CH1 connected to TI1 input
//                     <1=> TIM5CH1,CH2,CH3 connected to TI1 input
//         <o66.4..6> TIM5_CR2.MMS: Master Mode Selection  
//           <i> Default: Reset
//           <i> Select information to be sent in master mode to slave timers for synchronisation
//                     <0=> Reset
//                     <1=> Enable
...
//                     <6=> Compare OC3REF iused as TRGO
//                     <7=> Compare OC4REF iused as TRGO
//         <o66.3> TIM5_CR2.CCDS: Capture/Compare DMA Selection  
//           <i> Default: CC4 DMA request on CC4 event
//                     <0=> CC4 DMA request on CC4 event
//                     <1=> CC4 DMA request on update event
//       </h>
//
//       <h> Timer 5 Slave mode control register Configuration (TIM5_SMC)
//         <o67.15> TIM5_SMCR.ETP: External trigger polarity
//           <i> Default: ETR is non-inverted
//                     <0=> ETR is non-inverted
//                     <1=> ETR is inverted
//         <o67.14> TIM5_SMCR.ECE: External clock mode 2 enabled
//         <o67.12..13> TIM5_SMCR.ETPS: External trigger prescaler  
//           <i> Default: Prescaler OFF
//                     <0=> Prescaler OFF
//                     <1=> fETPR/2
//                     <2=> fETPR/4
//                     <3=> fETPR/8
//         <o67.8..11> TIM5_SMCR.ETF: External trigger filter  
//           <i> Default: No filter
//                     <0=>  No filter
//                     <1=>  fSampling=fCK_INT, N=2
//                     <2=>  fSampling=fCK_INT, N=4
...
//                     <14=> fSampling=fDTS/32, N=6
//                     <15=> fSampling=fDTS/32, N=8
//         <o67.7> TIM5_SMCR.MSM: Delay trigger input  
//         <o67.4..6> TIM5_SMCR.TS: Trigger Selection  
//           <i> Default: TIM1 (ITR0)
//                     <0=> TIM1 (ITR0)
//                     <1=> TIM2 (ITR1)
//                     <2=> TIM3 (ITR2)
...
//                     <6=> Filtered Timer Input 2 (TI1FP2)
//                     <7=> External Trigger Input (ETRF)
//         <o67.0..2> TIM5_SMCR.SMS: Slave mode selection   
//           <i> Default: Slave mode disabled
//                     <0=> Slave mode disabled
//                     <1=> Encoder mode 1
//                     <2=> Encoder mode 2
...
//       <h> Channel 1 Configuration
//         <h> Channel configured as output
//           <o68.7> TIM5_CCMR1.OC1CE: Output Compare 1 Clear enabled  
//           <o68.4..6> TIM5_CCMR1.OC1M: Output Compare 1 Mode  
//             <i> Default: Frozen
//                       <0=>  Frozen
//                       <1=>  Set channel 1 to active level on match
//                       <2=>  Set channel 1 to inactive level on match
...
//                       <6=>  PWM mode 1
//                       <7=>  PWM mode 2
//           <o68.3> TIM5_CCMR1.OC1PE: Output Compare 1 Preload enabled  
//           <o68.2> TIM5_CCMR1.OC1FE: Output Compare 1 Fast enabled  
//           <o68.0..1> TIM5_CCMR1.CC1S: Capture/compare 1 selection   
//             <i> Default: CC1 configured as output
//                       <0=> CC1 configured as output
//           <o68.1>  TIM5_CCER.CC1P: Capture/compare 1 output Polarity set  
//             <i> Default: OC1 active high
//                       <0=> OC1 active high
//                       <1=> OC1 active low
//           <o68.0>  TIM1_CCER.CC1E: Capture/compare 1 output enabled   
//             <i> Default: OC1 not active
//                       <0=> OC1 not active
//                       <1=> OC1 is output on corresponding pin
//         </h>
//         <h> Channel configured as input
//           <o68.4..7> TIM5_CCMR1.IC1F: Input Capture 1 Filter  
//             <i> Default: No filter
//                       <0=>  No filter
//                       <1=>  fSampling=fCK_INT, N=2
//                       <2=>  fSampling=fCK_INT, N=4
...
//                       <14=> fSampling=fDTS/32, N=6
//                       <15=> fSampling=fDTS/32, N=8
//           <o68.2..3> TIM5_CCMR1.IC1PSC: Input Capture 1 Prescaler  
//             <i> Default: No prescaler
//                       <0=>  No prescaler
//                       <1=>  capture every 2 events
//                       <2=>  capture every 4 events
...
//                       <2=> CC1 configured as input, IC1 mapped on TI2
//                       <3=> CC1 configured as input, IC1 mapped on TRGI
//           <o70.1>  TIM5_CCER.CC1P: Capture/compare 1 output Polarity set  
//             <i> Default: non-inverted
//                       <0=> non-inverted
//                       <1=> inverted
//           <o70.0>  TIM5_CCER.CC1E: Capture/compare 1 output enabled   
//             <i> Default: Capture disabled
//                       <0=> Capture disabled
//                       <1=> Capture enabled
//         </h>
//       <o71> TIM5_CCR1: Capture/compare register 1 <0-65535>
//         <i> Set the Compare register value for compare register 1.
//         <i> Default: 0
//     </h>
//
...
//       <h> Channel 2 Configuration
//         <h> Channel configured as output
//           <o68.15> TIM5_CCMR1.OC2CE: Output Compare 2 Clear enabled  
//           <o68.12..14> TIM5_CCMR1.OC2M: Output Compare 2 Mode  
//             <i> Default: Frozen
//                       <0=>  Frozen
//                       <1=>  Set channel 2 to active level on match
//                       <2=>  Set channel 2 to inactive level on match
...
//                       <6=>  PWM mode 1
//                       <7=>  PWM mode 2
//           <o68.11> TIM5_CCMR1.OC2PE: Output Compare 2 Preload enabled  
//           <o68.10> TIM5_CCMR1.OC2FE: Output Compare 2 Fast enabled  
//           <o68.8..9> TIM5_CCMR1.CC2S: Capture/compare 2 selection   
//             <i> Default: CC2 configured as output
//                       <0=> CC2 configured as output
//           <o70.5>  TIM5_CCER.CC2P: Capture/compare 2 output Polarity set  
//             <i> Default: OC2 active high
//                       <0=> OC2 active high
//                       <1=> OC2 active low
//           <o70.4>  TIM5_CCER.CC2E: Capture/compare 2 output enabled   
//             <i> Default: OC2 not active
//                       <0=> OC2 not active
//                       <1=> OC2 is output on corresponding pin
//         </h>
//         <h> Channel configured as input
//           <o68.12..15> TIM5_CCMR1.IC2F: Input Capture 2 Filter  
//             <i> Default: No filter
//                       <0=>  No filter
//                       <1=>  fSampling=fCK_INT, N=2
//                       <2=>  fSampling=fCK_INT, N=4
...
//                       <14=> fSampling=fDTS/32, N=6
//                       <15=> fSampling=fDTS/32, N=8
//           <o68.10..11> TIM5_CCMR1.IC2PSC: Input Capture 2 Prescaler  
//             <i> Default: No prescaler
//                       <0=>  No prescaler
//                       <1=>  capture every 2 events
//                       <2=>  capture every 4 events
...
//                       <1=> Capture enabled
//         </h>
//       <o72> TIM5_CCR2: Capture/compare register 2 <0-65535>
//         <i> Set the Compare register value for compare register 2.
//         <i> Default: 0
//     </h>
//
...
//       <h> Channel 3 Configuration
//         <h> Channel configured as output
//           <o69.7> TIM5_CCMR2.OC3CE: Output Compare 3 Clear enabled  
//           <o69.4..6> TIM5_CCMR2.OC3M: Output Compare 3 Mode  
//             <i> Default: Frozen
//                       <0=>  Frozen
//                       <1=>  Set channel 3 to active level on match
//                       <2=>  Set channel 3 to inactive level on match
...
//                       <6=>  PWM mode 1
//                       <7=>  PWM mode 2
//           <o69.3> TIM5_CCMR2.OC3PE: Output Compare 3 Preload enabled  
//           <o69.2> TIM5_CCMR2.OC3FE: Output Compare 3 Fast enabled  
//           <o69.0..1> TIM5_CCMR2.CC3S: Capture/compare 3 selection   
//             <i> Default: CC3 configured as output
//                       <0=> CC3 configured as output
//           <o70.9>  TIM5_CCER.CC3P: Capture/compare 3 output Polarity set  
//             <i> Default: OC3 active high
//                       <0=> OC3 active high
//                       <1=> OC3 active low
//           <o70.8>  TIM5_CCER.CC3E: Capture/compare 3 output enabled   
//             <i> Default: OC3 not active
//                       <0=> OC3 not active
//                       <1=> OC3 is output on corresponding pin
//         </h>
//         <h> Channel configured as input
//           <o69.4..7> TIM5_CCMR2.IC3F: Input Capture 3 Filter  
//             <i> Default: No filter
//                       <0=>  No filter
//                       <1=>  fSampling=fCK_INT, N=2
//                       <2=>  fSampling=fCK_INT, N=4
...
//                       <14=> fSampling=fDTS/32, N=6
//                       <15=> fSampling=fDTS/32, N=8
//           <o69.2..3> TIM5_CCMR2.IC3PSC: Input Capture 3 Prescaler  
//             <i> Default: No prescaler
//                       <0=>  No prescaler
//                       <1=>  capture every 2 events
//                       <2=>  capture every 4 events
...
//                       <1=> Capture enabled
//         </h>
//       <o73> TIM5_CCR3: Capture/compare register 3 <0-65535>
//         <i> Set the Compare register value for compare register 3.
//         <i> Default: 0
//     </h>
//
...
//       <h> Channel 4 Configuration
//         <h> Channel configured as output
//           <o69.15> TIM5_CCMR2.OC4CE: Output Compare 4 Clear enabled  
//           <o69.12..14> TIM5_CCMR2.OC4M: Output Compare 4 Mode  
//             <i> Default: Frozen
//                       <0=>  Frozen
//                       <1=>  Set channel 4 to active level on match
//                       <2=>  Set channel 4 to inactive level on match
...
//                       <6=>  PWM mode 1
//                       <7=>  PWM mode 2
//           <o69.11> TIM5_CCMR2.OC4PE: Output Compare 4 Preload enabled  
//           <o69.10> TIM5_CCMR2.OC4FE: Output Compare 4 Fast enabled  
//           <o69.8..9> TIM5_CCMR2.CC4S: Capture/compare 4 selection   
//             <i> Default: CC4 configured as output
//                       <0=> CC4 configured as output
//           <o70.13>  TIM5_CCER.CC4P: Capture/compare 4 output Polarity set  
//             <i> Default: OC4 active high
//                       <0=> OC4 active high
//                       <1=> OC4 active low
//           <o70.12>  TIM5_CCER.CC4E: Capture/compare 4 output enabled   
//             <i> Default: OC4 not active
//                       <0=> OC4 not active
//                       <1=> OC4 is output on corresponding pin
//         </h>
//         <h> Channel configured as input
//           <o68.12..15> TIM5_CCMR2.IC4F: Input Capture 4 Filter  
//             <i> Default: No filter
//                       <0=>  No filter
//                       <1=>  fSampling=fCK_INT, N=2
//                       <2=>  fSampling=fCK_INT, N=4
...
//                       <14=> fSampling=fDTS/32, N=6
//                       <15=> fSampling=fDTS/32, N=8
//           <o68.10..11> TIM5_CCMR2.IC4PSC: Input Capture 4 Prescaler  
//             <i> Default: No prescaler
//                       <0=>  No prescaler
//                       <1=>  capture every 2 events
//                       <2=>  capture every 4 events
//                       <3=>  capture every 8 events 
//           <o68.8..9> TIM5_CCMR2.CC4S: Capture/compare 4 selection   
//             <i> Default: CC4 configured as output
//                       <0=> CC4 configured as output
//                       <1=> CC4 configured as input, IC4 mapped on TI4
//                       <2=> CC4 configured as input, IC4 mapped on TI3
...
//                       <1=> Capture enabled
//         </h>
//       <o74> TIM5_CCR4: Capture/compare register 4 <0-65535>
//         <i> Set the Compare register value for compare register 4.
//         <i> Default: 0
//     </h>
//
//     </e>
//     <e3.4> TIM5 interrupts
//       <o75.14> TIM5_DIER.TDE: Trigger DMA request enabled
//       <o75.12> TIM5_DIER.CC4DE: Capture/Compare 4 DMA request enabled
//       <o75.11> TIM5_DIER.CC3DE: Capture/Compare 3 DMA request enabled
//       <o74.10> TIM5_DIER.CC2DE: Capture/Compare 2 DMA request enabled
//       <o75.9>  TIM5_DIER.CC1DE: Capture/Compare 1 DMA request enabled
//       <o75.8>  TIM5_DIER.UDE: Update DMA request enabled
//       <o75.6>  TIM5_DIER.TIE: Trigger interrupt enabled
//       <o75.4>  TIM5_DIER.CC4IE: Capture/Compare 4 interrupt enabled
//       <o75.3>  TIM5_DIER.CC3IE: Capture/Compare 3 interrupt enabled
//       <o75.2>  TIM5_DIER.CC2IE: Capture/Compare 2 interrupt enabled
//       <o75.1>  TIM5_DIER.CC1IE: Capture/Compare 1 interrupt enabled
//       <o75.0>  TIM5_DIER.UIE: Update interrupt enabled
//     </e>
//   </e>

//   <e1.5> TIM8 : Timer 8 enabled
//     <o76> TIM8 period [us] <1-72000000:10>
//       <i> Set the timer period for Timer 8.
//       <i> Default: 1000  (1ms)
//       <i> Ignored if detailed settings is selected
//     <o79> TIM8 repetition counter <0-255>
//       <i> Set the repetition counter for Timer 8.
//       <i> Default: 0
//       <i> Ignored if detailed settings is selected
//     <e2.5> TIM8 detailed settings
//--------------------------------------------------------------------------- Timer 8 detailed settings
//       <o77> TIM8.PSC: Timer8 Prescaler <0-65535>
//         <i> Set the prescaler for Timer 8.
//       <o78> TIM8.ARR: Timer8 Auto-reload <0-65535>
//         <i> Set the Auto-reload for Timer 8.
//       <o79> TIM8.RCR: Timer8 Repetition Counter <0-255>
//         <i> Set the Repetition Counter for Timer 8.
//
//       <h> Timer 8 Control Register 1 Configuration (TIM8_CR1)
//         <o80.8..9> TIM8_CR1.CKD: Clock division   
//           <i> Default: tDTS = tCK_INT
//           <i> devision ratio between timer clock and dead time
//                     <0=> tDTS = tCK_INT
//                     <1=> tDTS = 2*tCK_INT
//                     <2=> tDTS = 4*tCK_INT
//         <o80.7> TIM8_CR1.ARPE: Auto-reload preload enable
//           <i> Default: Auto-reload preload disenabled
//         <o80.5..6> TIM8_CR1.CMS: Center aligned mode selection   
//           <i> Default: Edge-aligned
//                     <0=> Edge-aligned
//                     <1=> Center-aligned mode1
//                     <2=> Center-aligned mode2
//                     <3=> Center-aligned mode3
//         <o80.4> TIM8_CR1.DIR: Direction
//           <i> Default: DIR = Counter used as up-counter
//           <i> read only if timer is configured as Center-aligned or Encoder mode   
//                     <0=> Counter used as up-counter
//                     <1=> Counter used as down-counter
//         <o80.3> TIM8_CR1.OPM: One pulse mode enable
//           <i> Default: One pulse mode disabled
//         <o80.2> TIM8_CR1.URS: Update request source   
//           <i> Default: URS = Counter over-/underflow, UG bit, Slave mode controller
//                     <0=> Counter over-/underflow, UG bit, Slave mode controller
//                     <1=> Counter over-/underflow
//         <o80.1> TIM8_CR1.UDIS: Update disable
//           <i> Default: Update enabled
//       </h>
//
//       <h> Timer 8 Control Register 2 Configuration (TIM8_CR2)
//         <o81.14> TIM8_CR2.OIS4: Output Idle state4 (OC4 output)   <0-1>
//         <o81.13> TIM8_CR2.OIS3N: Output Idle state3 (OC3N output) <0-1>
//         <o81.12> TIM8_CR2.OIS3: Output Idle state3 (OC3 output)   <0-1>
//         <o81.11> TIM8_CR2.OIS2N: Output Idle state2 (OC2N output) <0-1> 
//         <o81.10> TIM8_CR2.OIS2: Output Idle state2 (OC2 output)   <0-1>
//         <o81.9> TIM8_CR2.OIS1N: Output Idle state1 (OC1N output)
//           <i> Default: OC1 = 0
//                     <0=> OC1N=0 when MOE=0
//                     <1=> OC1N=1 when MOE=0
//         <o81.8> TIM8_CR2.OI1S: Output Idle state1 (OC1 output)  
//           <i> Default: OC1=0
//                     <0=> OC1=0 when MOE=0
//                     <1=> OC1=1 when MOE=0
//         <o81.7> TIM8_CR2.TI1S: TI1 Selection  
//           <i> Default: TIM8CH1 connected to TI1 input
//                     <0=> TIM8CH1 connected to TI1 input
//                     <1=> TIM8CH1,CH2,CH3 connected to TI1 input
//         <o81.4..6> TIM8_CR2.MMS: Master Mode Selection  
//           <i> Default: Reset
//           <i> Select information to be sent in master mode to slave timers for synchronisation
//                     <0=> Reset
//                     <1=> Enable
...
//                     <6=> Compare OC3REF iused as TRGO
//                     <7=> Compare OC4REF iused as TRGO
//         <o81.2> TIM8_CR2.CCUS: Capture/Compare Control Update Selection  
//           <i> Default: setting COM bit
//                     <0=> setting COM bit
//                     <1=> setting COM bit or rising edge TRGI
//         <o81.0> TIM8_CR2.CCPC: Capture/Compare Preloaded Control   
//           <i> Default: CCxE,CCxNE,OCxM not preloaded
//                     <0=> CCxE,CCxNE,OCxM not preloaded
//                     <1=> CCxE,CCxNE,OCxM preloaded
//       </h>
//
//       <h> Timer 8 Slave mode control register Configuration (TIM8_SMC)
//         <o82.15> TIM8_SMCR.ETP: External trigger polarity
//           <i> Default: ETR is non-inverted
//                     <0=> ETR is non-inverted
//                     <1=> ETR is inverted
//         <o82.14> TIM8_SMCR.ECE: External clock mode 2 enabled
//         <o82.12..13> TIM8_SMCR.ETPS: External trigger prescaler  
//           <i> Default: Prescaler OFF
//                     <0=> Prescaler OFF
//                     <1=> fETPR/2
//                     <2=> fETPR/4
//                     <3=> fETPR/8
//         <o82.8..11> TIM8_SMCR.ETF: External trigger filter  
//           <i> Default: No filter
//                     <0=>  No filter
//                     <1=>  fSampling=fCK_INT, N=2
//                     <2=>  fSampling=fCK_INT, N=4
...
//                     <14=> fSampling=fDTS/32, N=6
//                     <15=> fSampling=fDTS/32, N=8
//         <o82.7> TIM8_SMCR.MSM: Delay trigger input  
//         <o82.4..6> TIM8_SMCR.TS: Trigger Selection  
//           <i> Default: Reserved
//                     <0=> Reserved
//                     <1=> TIM2 (ITR1)
//                     <2=> TIM3 (ITR2)
...
//                     <6=> Filtered Timer Input 2 (TI1FP2)
//                     <7=> External Trigger Input (ETRF)
//         <o82.0..2> TIM8_SMCR.SMS: Slave mode selection   
//           <i> Default: Slave mode disabled
//                     <0=> Slave mode disabled
//                     <1=> Encoder mode 1
//                     <2=> Encoder mode 2
...
//       <h> Channel 1 Configuration
//         <h> Channel configured as output
//           <o83.7> TIM8_CCMR1.OC1CE: Output Compare 1 Clear enabled  
//           <o83.4..6> TIM8_CCMR1.OC1M: Output Compare 1 Mode  
//             <i> Default: Frozen
//                       <0=>  Frozen
//                       <1=>  Set channel 1 to active level on match
//                       <2=>  Set channel 1 to inactive level on match
...
//                       <6=>  PWM mode 1
//                       <7=>  PWM mode 2
//           <o83.3> TIM8_CCMR1.OC1PE: Output Compare 1 Preload enabled  
//           <o83.2> TIM8_CCMR1.OC1FE: Output Compare 1 Fast enabled  
//           <o83.0..1> TIM8_CCMR1.CC1S: Capture/compare 1 selection   
//             <i> Default: CC1 configured as output
//                       <0=> CC1 configured as output
//           <o85.3> TIM8_CCER.CC1NP: Capture/compare 1 Complementary output Polarity set  
//             <i> Default: OC1N active high
//                       <0=> OC1N active high
//                       <1=> OC1N active low
//           <o85.2> TIM8_CCER.CC1NE: Capture/compare 1 Complementary output enabled
//             <i> Default: OC1N not active
//                       <0=> OC1N not active
//                       <1=> OC1N is output on corresponding pin
//           <o85.1> TIM8_CCER.CC1P: Capture/compare 1 output Polarity set  
//             <i> Default: OC1 active high
//                       <0=> OC1 active high
//                       <1=> OC1 active low
//           <o85.0>  TIM8_CCER.CC1E: Capture/compare 1 output enabled   
//             <i> Default: OC1 not active
//                       <0=> OC1 not active
//                       <1=> OC1 is output on corresponding pin
//         </h>
//         <h> Channel configured as input
//           <o83.4..7> TIM8_CCMR1.IC1F: Input Capture 1 Filter  
//             <i> Default: No filter
//                       <0=>  No filter
//                       <1=>  fSampling=fCK_INT, N=2
//                       <2=>  fSampling=fCK_INT, N=4
...
//                       <14=> fSampling=fDTS/32, N=6
//                       <15=> fSampling=fDTS/32, N=8
//           <o83.2..3> TIM8_CCMR1.IC1PSC: Input Capture 1 Prescaler  
//             <i> Default: No prescaler
//                       <0=>  No prescaler
//                       <1=>  capture every 2 events
//                       <2=>  capture every 4 events
...
//                       <1=> Capture enabled
//         </h>
//       <o86> TIM8_CCR1: Capture/compare register 1 <0-65535>
//         <i> Set the Compare register value for compare register 1.
//         <i> Default: 0
//     </h>
//
...
//       <h> Channel 2 Configuration
//         <h> Channel configured as output
//           <o83.15> TIM8_CCMR1.OC2CE: Output Compare 2 Clear enabled  
//           <o83.12..14> TIM8_CCMR1.OC2M: Output Compare 2 Mode  
//             <i> Default: Frozen
//                       <0=>  Frozen
//                       <1=>  Set channel 2 to active level on match
//                       <2=>  Set channel 2 to inactive level on match
...
//                       <6=>  PWM mode 1
//                       <7=>  PWM mode 2
//           <o83.11> TIM8_CCMR1.OC2PE: Output Compare 2 Preload enabled  
//           <o83.10> TIM8_CCMR1.OC2FE: Output Compare 2 Fast enabled  
//           <o83.8..9> TIM8_CCMR1.CC2S: Capture/compare 2 selection   
//             <i> Default: CC2 configured as output
//                       <0=> CC2 configured as output
//           <o85.7> TIM8_CCER.CC2NP: Capture/compare 2 Complementary output Polarity set  
//             <i> Default: OC2N active high
//                       <0=> OC2N active high
//                       <1=> OC2N active low
//           <o85.6> TIM8_CCER.CC2NE: Capture/compare 2 Complementary output enabled
//             <i> Default: OC2N not active
//                       <0=> OC2N not active
//                       <1=> OC2N is output on corresponding pin
//           <o85.5>  TIM8_CCER.CC2P: Capture/compare 2 output Polarity set  
//             <i> Default: OC2 active high
//                       <0=> OC2 active high
//                       <1=> OC2 active low
//           <o85.4>  TIM8_CCER.CC2E: Capture/compare 2 output enabled   
//             <i> Default: OC2 not active
//                       <0=> OC2 not active
//                       <1=> OC2 is output on corresponding pin
//         </h>
//         <h> Channel configured as input
//           <o83.12..15> TIM8_CCMR1.IC2F: Input Capture 2 Filter  
//             <i> Default: No filter
//                       <0=>  No filter
//                       <1=>  fSampling=fCK_INT, N=2
//                       <2=>  fSampling=fCK_INT, N=4
...
//                       <14=> fSampling=fDTS/32, N=6
//                       <15=> fSampling=fDTS/32, N=8
//           <o83.10..11> TIM8_CCMR1.IC2PSC: Input Capture 2 Prescaler  
//             <i> Default: No prescaler
//                       <0=>  No prescaler
//                       <1=>  capture every 2 events
//                       <2=>  capture every 4 events
...
//                       <1=> Capture enabled
//         </h>
//       <o87> TIM8_CCR2: Capture/compare register 2 <0-65535>
//         <i> Set the Compare register value for compare register 2.
//         <i> Default: 0
//     </h>
//
...
//       <h> Channel 3 Configuration
//         <h> Channel configured as output
//           <o84.7> TIM8_CCMR2.OC3CE: Output Compare 3 Clear enabled  
//           <o84.4..6> TIM8_CCMR2.OC3M: Output Compare 3 Mode  
//             <i> Default: Frozen
//                       <0=>  Frozen
//                       <1=>  Set channel 3 to active level on match
//                       <2=>  Set channel 3 to inactive level on match
...
//                       <6=>  PWM mode 1
//                       <7=>  PWM mode 2
//           <o84.3> TIM8_CCMR2.OC3PE: Output Compare 3 Preload enabled  
//           <o84.2> TIM8_CCMR2.OC3FE: Output Compare 3 Fast enabled  
//           <o84.0..1> TIM8_CCMR2.CC3S: Capture/compare 3 selection   
//             <i> Default: CC3 configured as output
//                       <0=> CC3 configured as output
//           <o85.11> TIM8_CCER.CC3NP: Capture/compare 3 Complementary output Polarity set  
//             <i> Default: OC3N active high
//                       <0=> OC3N active high
//                       <1=> OC3N active low
//           <o85.10> TIM8_CCER.CC3NE: Capture/compare 3 Complementary output enabled
//             <i> Default: OC3N not active
//                       <0=> OC3N not active
//                       <1=> OC3N is output on corresponding pin
//           <o85.9>  TIM8_CCER.CC3P: Capture/compare 3 output Polarity set  
//             <i> Default: OC3 active high
//                       <0=> OC3 active high
//                       <1=> OC3 active low
//           <o85.8>  TIM8_CCER.CC3E: Capture/compare 3 output enabled   
//             <i> Default: OC3 not active
//                       <0=> OC3 not active
//                       <1=> OC3 is output on corresponding pin
//         </h>
//         <h> Channel configured as input
//           <o84.4..7> TIM8_CCMR2.IC3F: Input Capture 3 Filter  
//             <i> Default: No filter
//                       <0=>  No filter
//                       <1=>  fSampling=fCK_INT, N=2
//                       <2=>  fSampling=fCK_INT, N=4
...
//                       <14=> fSampling=fDTS/32, N=6
//                       <15=> fSampling=fDTS/32, N=8
//           <o84.2..3> TIM8_CCMR2.IC3PSC: Input Capture 3 Prescaler  
//             <i> Default: No prescaler
//                       <0=>  No prescaler
//                       <1=>  capture every 2 events
//                       <2=>  capture every 4 events
...
//                       <1=> Capture enabled
//         </h>
//       <o88> TIM8_CCR3: Capture/compare register 3 <0-65535>
//         <i> Set the Compare register value for compare register 3.
//         <i> Default: 0
//     </h>
//
...
//       <h> Channel 4 Configuration
//         <h> Channel configured as output
//           <o12.15> TIM8_CCMR2.OC4CE: Output Compare 4 Clear enabled  
//           <o12.12..14> TIM8_CCMR2.OC4M: Output Compare 4 Mode  
//             <i> Default: Frozen
//                       <0=>  Frozen
//                       <1=>  Set channel 4 to active level on match
//                       <2=>  Set channel 4 to inactive level on match
...
//                       <6=>  PWM mode 1
//                       <7=>  PWM mode 2
//           <o84.11> TIM8_CCMR2.OC4PE: Output Compare 4 Preload enabled  
//           <o84.10> TIM8_CCMR2.OC4FE: Output Compare 4 Fast enabled  
//           <o84.8..9> TIM8_CCMR2.CC4S: Capture/compare 4 selection   
//             <i> Default: CC4 configured as output
//                       <0=> CC4 configured as output
//           <o85.13>  TIM8_CCER.CC4P: Capture/compare 4 output Polarity set  
//             <i> Default: OC4 active high
//                       <0=> OC4 active high
//                       <1=> OC4 active low
//           <o85.12>  TIM8_CCER.CC4E: Capture/compare 4 output enabled   
//             <i> Default: OC4 not active
//                       <0=> OC4 not active
//                       <1=> OC4 is output on corresponding pin
//         </h>
//         <h> Channel configured as input
//           <o84.12..15> TIM8_CCMR2.IC4F: Input Capture 4 Filter  
//             <i> Default: No filter
//                       <0=>  No filter
//                       <1=>  fSampling=fCK_INT, N=2
//                       <2=>  fSampling=fCK_INT, N=4
...
//                       <14=> fSampling=fDTS/32, N=6
//                       <15=> fSampling=fDTS/32, N=8
//           <o84.10..11> TIM8_CCMR2.IC4PSC: Input Capture 4 Prescaler  
//             <i> Default: No prescaler
//                       <0=>  No prescaler
//                       <1=>  capture every 2 events
//                       <2=>  capture every 4 events
...
//                       <2=> CC4 configured as input, IC4 mapped on TI3
//                       <3=> CC4 configured as input, IC4 mapped on TRGI
//           <o84.13>  TIM8_CCER.CC4P: Capture/compare 4 output Polarity set  
//             <i> Default: non-inverted
//                       <0=> non-inverted
//                       <1=> inverted
//           <o85.12>  TIM8_CCER.CC4E: Capture/compare 4 output enabled   
...
//                       <1=> Capture enabled
//         </h>
//       <o89> TIM8_CCR4: Capture/compare register 4 <0-65535>
//         <i> Set the Compare register value for compare register 4.
//         <i> Default: 0
//     </h>
//
//       <h> Timer8 Break and dead-time register Configuration (TIM8_BDTR)
//         <o90.15> TIM8_BDTR.MOE: Main Output enabled
//         <o90.14> TIM8_BDTR.AOE: Automatic Output enabled
//         <o90.13> TIM8_BDTR.BKP: Break Polarity active high
//         <o90.12> TIM8_BDTR.BKE: Break Inputs enabled
//         <o90.11> TIM8_BDTR.OSSR: Off-State Selection for Run mode
//           <i> Default: OC/OCN output signal=0
//                     <0=> OC/OCN output signal=0
//                     <1=> OC/OCN output signal=1
//         <o90.10> TIM8_BDTR.OSSI: Off-State Selection for Idle mode
//           <i> Default: OC/OCN output signal=0
//                     <0=> OC/OCN output signal=0
//                     <1=> OC/OCN output signal=1
//         <o90.8..9> TIM8_BDTR.LOCK: Lock Level <0-3>
//           <i> Default: 0 (LOCK OFF)
//         <o90.0..7> TIM8_BDTR.DTG: Dead-Time Generator set-up <0x00-0xFF>   
//       </h>
//
//     </e>
//     <e3.0> TIM8 interrupts
//       <o91.14> TIM8_DIER.TDE: Trigger DMA request enabled
//       <o91.12> TIM8_DIER.CC4DE: Capture/Compare 4 DMA request enabled
//       <o91.11> TIM8_DIER.CC3DE: Capture/Compare 3 DMA request enabled
//       <o91.10> TIM8_DIER.CC2DE: Capture/Compare 2 DMA request enabled
//       <o91.9>  TIM8_DIER.CC1DE: Capture/Compare 1 DMA request enabled
//       <o91.8>  TIM8_DIER.UDE: Update DMA request enabled
//       <o91.7>  TIM8_DIER.BIE: Break interrupt enabled
//       <o91.6>  TIM8_DIER.TIE: Trigger interrupt enabled
//       <o91.5>  TIM8_DIER.COMIE: COM interrupt enabled
//       <o91.4>  TIM8_DIER.CC4IE: Capture/Compare 4 interrupt enabled
//       <o91.3>  TIM8_DIER.CC3IE: Capture/Compare 3 interrupt enabled
//       <o91.2>  TIM8_DIER.CC2IE: Capture/Compare 2 interrupt enabled
//       <o91.1>  TIM8_DIER.CC1IE: Capture/Compare 1 interrupt enabled
//       <o91.0>  TIM8_DIER.UIE: Update interrupt enabled
//     </e>
//   </e>
// </e> End of Timer Configuration

#define __TIMER_SETUP             1                       //  0
#define __TIMER_USED              0x002D                  //  1
#define __TIMER_DETAILS           0x003D                  //  2
#define __TIMER_INTERRUPTS        0x0002                  //  3

#define __TIM1_PERIOD             0x0003E8                 //  4
#define __TIM1_PSC                0x0000                  //  5
#define __TIM1_ARR                0xFFFF                  //  6
#define __TIM1_RCR                0x0000                  //  7
#define __TIM1_CR1                0x0004                  //  8
#define __TIM1_CR2                0x0035                  //  9
#define __TIM1_SMCR               0x0053                  // 10
#define __TIM1_CCMR1              0x0101                  // 11
#define __TIM1_CCMR2              0x0000                  // 12
#define __TIM1_CCER               0x0131                  // 13
#define __TIM1_CCR1               0x0000                  // 14
#define __TIM1_CCR2               0x0000                  // 15
#define __TIM1_CCR3               0x0000                  // 16
#define __TIM1_CCR4               0x0000                  // 17
#define __TIM1_BDTR               0xC000                  // 18
#define __TIM1_DIER               0x0001                  // 19

#define __TIM2_PERIOD             0x00003E8                 // 20
#define __TIM2_PSC                0x0BB8                  // 21
#define __TIM2_ARR                0x2710                  // 22
#define __TIM2_CR1                0x0084                  // 23
#define __TIM2_CR2                0x0030                  // 24
#define __TIM2_SMCR               0x0053                  // 25
#define __TIM2_CCMR1              0x0101                  // 26
#define __TIM2_CCMR2              0x0000                  // 27
#define __TIM2_CCER               0x0011                  // 28
...
#define __TIM3_CR2                0x0030                  // 38
#define __TIM3_SMCR               0x0053                  // 39
#define __TIM3_CCMR1              0x0101                  // 40
...
#define __TIM4_ARR                0xFFFF                  // 50
#define __TIM4_CR1                0x0004                  // 51
#define __TIM4_CR2                0x0030                  // 52
#define __TIM4_SMCR               0x0053                  // 53
#define __TIM4_CCMR1              0x0101                  // 54
#define __TIM4_CCMR2              0xFFFF0000                  // 55
#define __TIM4_CCER               0x1131                  // 56
...
#define __TIM5_PERIOD             0x01388                 // 62
#define __TIM5_PSC                0x0000                  // 63
#define __TIM5_ARR                65535                  // 64
#define __TIM5_CR1                0x0004                  // 65
#define __TIM5_CR2                0x0030                  // 66
#define __TIM5_SMCR               0x0053                  // 67
#define __TIM5_CCMR1              0x0001                  // 68
#define __TIM5_CCMR2              0x0000                  // 69
#define __TIM5_CCER               0x0011                  // 70
#define __TIM5_CCR1               0x0000                  // 71
#define __TIM5_CCR2               0x0000                  // 72
#define __TIM5_CCR3               0x0000                  // 73
#define __TIM5_CCR4               0x0000                  // 74
#define __TIM5_DIER               0x0001                  // 75


#define __TIM8_PERIOD             0x004E20                //  76
#define __TIM8_PSC                0x0018                  //  77
#define __TIM8_ARR                0x0BB7                  //  78
#define __TIM8_RCR                0x0000                  //  79
#define __TIM8_CR1                0x0084                  //  80
#define __TIM8_CR2                0x0005                  //  81
#define __TIM8_SMCR               0x0050                  // 82
#define __TIM8_CCMR1              0x6060                  // 83
#define __TIM8_CCMR2              0x0060                  // 84
#define __TIM8_CCER               0x0DDD                  // 85
#define __TIM8_CCR1               0x0000                  // 86
#define __TIM8_CCR2               0x0000                  // 87
#define __TIM8_CCR3               0x0000                  // 88
#define __TIM8_CCR4               0x0000                  // 89
#define __TIM8_BDTR               0xC000                  // 90
#define __TIM8_DIER               0x0001                  // 91
//=========================================================================== USART Configuration
...
#define __EXTI_INTERRUPTS         0x0000FF9F              //  2
#define __EXTI_IMR                0x0000FF9F              //  3
#define __EXTI_EMR                0x00000000              //  4
#define __EXTI_RTSR               0x0000331D              //  5
#define __EXTI_FTSR               0x0000FF9F              //  6
#define __AFIO_EXTICR1            0x00003323              //  7
#define __AFIO_EXTICR2            0x00004003              //  8
#define __AFIO_EXTICR3            0x00002233              //  9
#define __AFIO_EXTICR4            0x00000312              // 10
...
//--------------------------------------------------------------------------- Disable JTAG
//   <o1.26> Disable JTAG and JDI
//      <i> Default: JTAG Enabled
//        <0=>         JTAG Enabled
//        <1=>         JTAG Disabled

// </e> End of Alternate Function remap Configuration
#define __AFREMAP_SETUP           1                       //  0
#define __AFIO_MAPR               0x04000CCA              //  1
...
#define __GPIOA_CRL               0x91011111
#define __GPIOA_CRH               0x88188888
#define __GPIOB_CRL               0x44141199
#define __GPIOB_CRH               0x1111DDFF
#define __GPIOC_CRL               0x44010000
#define __GPIOC_CRH               0x85815888
#define __GPIOD_CRL               0x84911111
#define __GPIOD_CRH               0x99991151
#define __GPIOE_CRL               0x18188118
#define __GPIOE_CRH               0x19114341
#define __GPIOF_CRL               0x00000000
#define __GPIOF_CRH               0x88873330
#define __GPIOG_CRL               0x00008880
...
__inline static void stm32_ClockSetup (void) {
  ...
  // URUTAN INISIALISASI HARUS DIBUAT SEPERTI INI, APABILA TIDAK pll TIDAK BISA BEKERJA DIATAS 48MHZ
...
__inline static void stm32_TimerSetup (void) {
  ...
  if (__TIMER_USED & 0x10) {                                // TIM5 used
    RCC->APB1ENR |= 8; //RCC_APB1ENR_TIM5EN;                     // enable clock for TIM5

    TIM5->PSC = __PSC(__TIMXCLK, __TIM5_PERIOD);            // set prescaler
    TIM5->ARR = __ARR(__TIMXCLK, __TIM5_PERIOD);            // set auto-reload

    TIM5->CR1 = 0;                                          // reset command register 1
    TIM5->CR2 = 0;                                          // reset command register 2

    if (__TIMER_DETAILS & 0x10) {                           // detailed settings used
      TIM5->PSC = __TIM5_PSC;                               // set prescaler
      TIM5->ARR = __TIM5_ARR;                               // set auto-reload

      TIM5->CCR1  = __TIM5_CCR1;                            //
      TIM5->CCR2  = __TIM5_CCR2;                            //
      TIM5->CCR3  = __TIM5_CCR3;                            //
      TIM5->CCR4  = __TIM5_CCR4;                            //
      TIM5->CCMR1 = __TIM5_CCMR1;                           //
      TIM5->CCMR2 = __TIM5_CCMR2;                           //
      TIM5->CCER  = __TIM5_CCER;                            // set capture/compare enable register
      TIM5->SMCR  = __TIM5_SMCR;                            // set slave mode control register

      TIM5->CR1 = __TIM5_CR1;                               // set command register 1
      TIM5->CR2 = __TIM5_CR2;                               // set command register 2
    }

    if (__TIMER_INTERRUPTS & 0x10) {                        // interrupts used
      TIM5->DIER = __TIM5_DIER;                             // enable interrupt
      NVIC->ISER[0] |= (1 << (TIM5_IRQChannel & 0x1F));     // enable interrupt
    }

    TIM5->CR1 |= TIMX_CR1_CEN;                              // enable timer
  } // end TIM5 used
	

  if (__TIMER_USED & 0x20) {                                // TIM8 used
    RCC->APB2ENR |= 8192;                     				// enable clock for TIM8

    TIM8->PSC = __PSC(__TIM1CLK, __TIM8_PERIOD);            // set prescaler
    TIM8->ARR = __ARR(__TIM1CLK, __TIM8_PERIOD);            // set auto-reload
    TIM8->RCR = __TIM8_RCR;                                 // set repetition counter

    TIM8->CR1 = 0;                                          // reset command register 1
    TIM8->CR2 = 0;                                          // reset command register 2

    if (__TIMER_DETAILS & 0x20) {                           // detailed settings used
      TIM8->PSC = __TIM8_PSC;                               // set prescaler
      TIM8->ARR = __TIM8_ARR;                               // set auto-reload

      TIM8->CCR1  = __TIM8_CCR1;                            //
      TIM8->CCR2  = __TIM8_CCR2;                            //
      TIM8->CCR3  = __TIM8_CCR3;                            //
      TIM8->CCR4  = __TIM8_CCR4;                            //
      TIM8->CCMR1 = __TIM8_CCMR1;                           //
      TIM8->CCMR2 = __TIM8_CCMR2;                           //
      TIM8->CCER  = __TIM8_CCER;                            // set capture/compare enable register
      TIM8->SMCR  = __TIM8_SMCR;                            // set slave mode control register
      TIM8->BDTR  = __TIM8_BDTR;                            // set break and dead-time register

      TIM8->CR1 = __TIM8_CR1;                               // set command register 1
      TIM8->CR2 = __TIM8_CR2;                               // set command register 2
    }
 
    if (__TIMER_INTERRUPTS & 0x20) {                        // interrupts used
      TIM8->DIER = __TIM8_DIER;                             // enable interrupt
      NVIC->ISER[0] |= (1 << (TIM8_UP_IRQChannel & 0x1F));  // enable interrupt
    }
	
    TIM8->CR1 |= TIMX_CR1_CEN;                              // enable timer
  } // end TIM8 used
...
__inline static void stm32_AfRemapSetup (void) {
  ...
  if (__AFIO_MAPR & (1 << 26)) {                            // Disable JTAG function

    RCC->APB2ENR |= RCC_APB2ENR_AFIOEN;                     // enable clock for Alternate Function
    AFIO->MAPR &= ~(1 << 26);                               // clear used bit
    AFIO->MAPR |= ((1 << 26) & __AFIO_MAPR);                // set used bits
  } // end disable JTAG pins
